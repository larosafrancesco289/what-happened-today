      ...
      <div className="flex items-center justify-between gap-4">
        ...
        >
          ...
          <div className="text-left hidden sm:block">
            <div className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wide font-medium">Previous</div>
            <div className="font-semibold text-slate-900 dark:text-slate-100 group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors">{formatDate(previousDate)}</div>
          </div>
          <div className="text-left sm:hidden">
            <div className="font-semibold text-sm text-slate-900 dark:text-slate-100">Previous</div>
          </div>
        </Link>
        ...
        {hasNextDate && (
          ...
          >
            <div className="text-right hidden sm:block">
              <div className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wide font-medium">Next</div>
              <div className="font-semibold text-slate-900 dark:text-slate-100 group-hover:text-slate-700 dark:group-hover:text-slate-200 transition-colors">{formatDate(nextDate)}</div>
            </div>
            <div className="text-right sm:hidden">
              <div className="font-semibold text-sm text-slate-900 dark:text-slate-100">Next</div>
            </div>
